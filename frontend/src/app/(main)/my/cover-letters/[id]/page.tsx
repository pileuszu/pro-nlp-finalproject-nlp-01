...
import { ArrowLeft, Save, Sparkles, Loader2, Info, Briefcase, BookOpen, X, ExternalLink, Building, AlignLeft, Plus, Trash2, FileText, Github, Brain, CheckCircle, Target, MessageSquare, Wand2, Zap, LayoutList, PenTool, Calendar } from "lucide-react";
